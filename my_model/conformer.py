...
from my_model.En_De_coder import Bi_mlstm, mlstm
...
class ConformerBlock(nn.Module):
    def __init__(
        ...
        # self.lstm = Bi_mlstm(mlstm_cfg,input_dim)
        self.lstm = mlstm(mlstm_cfg,input_dim)
...
class TSCB(nn.Module):
    def __init__(self,context_length, embedding_dim, mlstm_cfg_time, mlstm_cfg_freq):
        super(TSCB, self).__init__()
        self.time_conformer = ConformerBlock(
            input_dim=embedding_dim,
            mlstm_cfg=mlstm_cfg_time
        )
        self.freq_conformer = ConformerBlock(
            input_dim=context_length,
            mlstm_cfg=mlstm_cfg_freq
        )
