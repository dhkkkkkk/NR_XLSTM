...
class Trainer:
    def __init__(self, train_ds, test_ds, args, device):
        ...
        self.args = args
        self.device = device
        self.generator = generator_new(layer= self.args.layer,
                                       in_channels=2,
    ...
    def forward_generator_step(self, clean, noisy):
        ...
        est_real, est_imag, class_outputs = self.generator(n_input, self.args.detach_decoder) #(b,f,t)
    ...
    def calculate_generator_loss(self, generator_outputs):
        ...
        loss = torch.stack([
            ...
            self.args.loss_weights[4] * pha_loss
        ])
        return loss
...
def main():
    ...
    parser.add_argument("--loss_weights", type=list, default=[0.2, 1.5, 0.5, 0.1, 0.03],
                        help="weights of RI components, magnitude, time loss, sisnr loss, phaloss")
    ...
    parser.add_argument("--layer",type=list, default=[4, 4, 8, 1, 1],
                        help="layer num of mlstm, tscbs, encoder, m_decoder, c_decoder")
