...
class Trainer:
    def __init__(self, train_ds, test_ds, args, device):
        ...
        self.ori_model = TCN(201,201,layers=[256,256,256,128,128,128,64,64,64],ks=3,conv_dropout=0.2,fc_dropout=0.2)
...
def main():
    ...
    parser.add_argument("--loss_weights", type=list, default=[0.2, 1.5, 0.5, 0.1, 0.0001, 0.03],
                        help="weights of RI components, magnitude, time loss, sisnr loss, score loss, phaloss")# 0.05
    ...
    parser.add_argument("--layer",type=list, default=[4, 4, 8, 2, 2],
